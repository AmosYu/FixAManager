...
package fam.ctl.fixamanager.zxing.zxing.camera;
...
public final class CameraManager {
    ...
    public static int MAX_FRAME_WIDTH = 240;
    public static int MAX_FRAME_HEIGHT = 240; // = 5/8 * 1080
    ...
    private CameraManager(Context context) {
        ...
        MIN_FRAME_WIDTH = dip2px(240);
        MIN_FRAME_HEIGHT = dip2px(240);
        MAX_FRAME_WIDTH = dip2px(240);
        MAX_FRAME_HEIGHT = dip2px(240);
