package fam.ctl.fixamanager.zxing;
...
import fam.ctl.fixamanager.BuildConfig;
import fam.ctl.fixamanager.R;
import fam.ctl.fixamanager.zxing.common.ActionUtils;
import fam.ctl.fixamanager.zxing.common.QrUtils;
import fam.ctl.fixamanager.zxing.zxing.camera.CameraManager;
import fam.ctl.fixamanager.zxing.zxing.decoding.CaptureActivityHandler;
import fam.ctl.fixamanager.zxing.zxing.decoding.InactivityTimer;
import fam.ctl.fixamanager.zxing.zxing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
    ...
    protected void initView() {
        ...
        //设置隐藏还是显示
        mLayoutChoose.setVisibility(!getIntent().getBooleanExtra("flash", true) ? View.GONE : View.VISIBLE);
